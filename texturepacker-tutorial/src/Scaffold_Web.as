package
{
    ...
    public class Scaffold_Web extends Sprite
    {        
        ...
        public function Scaffold_Web()
        {
			...
			assets.enqueue(formatString("./textures/{0}x/atlas.png", scaleFactor));
			assets.enqueue(formatString("./textures/{0}x/atlas.xml", scaleFactor));
